    ...
    public class SuperLevelOptimizerEditor : Editor
    {
        ...
        private void OnCombineMeshes()
        {
            ...
            if (target.combineState == CombineState.CombineToPrefab && combinedRoot != null)
            {
                ...
                foreach (var mark in (SLO_AtlasMark[])  Resources.FindObjectsOfTypeAll(typeof(SLO_AtlasMark)))
                    DestroyImmediate(mark.gameObject);

                foreach (var mark in (SLO_SourceMark[]) Resources.FindObjectsOfTypeAll(typeof(SLO_SourceMark)))
                {
        ...
        {
            SLO_SourceMark[] marks = (SLO_SourceMark[]) Resources.FindObjectsOfTypeAll(typeof(SLO_SourceMark));
        ...
        {
            SLO_SourceMark[] sourceMarks = (SLO_SourceMark[]) Resources.FindObjectsOfTypeAll(typeof(SLO_SourceMark));
